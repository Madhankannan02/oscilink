...
interface SevenSegmentCAProps {
  component: CircuitComponent;
}

export const SevenSegmentCA = memo(({ component }: SevenSegmentCAProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Labels */}
      <Text x={5} y={68} fontSize={6} fill="#3b82f6" fontStyle="bold" text="CA" />
