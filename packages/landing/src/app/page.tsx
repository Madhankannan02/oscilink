...
<div class="aspect-video rounded mb-4 overflow-hidden flex items-center justify-center relative">
<img src="/assets/led_blinking.svg" alt="LED Blink" class="object-contain w-full h-full" />
</div>
...
<div class="bg-surface-bright p-6 rounded-lg border border-outline-variant/20 soft-shadow flex flex-col hover:border-primary/40 transition-all group">
<div class="aspect-video rounded mb-4 overflow-hidden flex items-center justify-center relative">
<img src="/assets/traffic_light_controller.svg" alt="Traffic Light Controller" class="object-contain w-full h-full" />
</div>
...
<div class="bg-surface-bright p-6 rounded-lg border border-outline-variant/20 soft-shadow flex flex-col hover:border-primary/40 transition-all group">
<div class="aspect-video rounded mb-4 overflow-hidden flex items-center justify-center relative">
<img src="/assets/servo_sweep.svg" alt="Servo Sweep" class="object-contain w-full h-full" />
</div>
...
<div class="bg-surface-bright p-6 rounded-lg border border-outline-variant/20 soft-shadow flex flex-col hover:border-primary/40 transition-all group">
<div class="aspect-video rounded mb-4 overflow-hidden flex items-center justify-center relative">
<img src="/assets/ultrasonic_distance_meter.svg" alt="Ultrasonic Distance Meter" class="object-contain w-full h-full" />
</div>
...
<div class="bg-surface-bright p-6 rounded-lg border border-outline-variant/20 soft-shadow flex flex-col hover:border-primary/40 transition-all group">
<div class="aspect-video rounded mb-4 overflow-hidden flex items-center justify-center relative">
<img src="/assets/temperature_monitor.svg" alt="Temperature Monitor" class="object-contain w-full h-full" />
</div>
...
<div class="bg-surface-bright p-6 rounded-lg border border-outline-variant/20 soft-shadow flex flex-col hover:border-primary/40 transition-all group">
<div class="aspect-video rounded mb-4 overflow-hidden flex items-center justify-center relative">
<img src="/assets/seven_segment_digit_count.svg" alt="7-Segment Digit Counter" class="object-contain w-full h-full" />
</div>
...
<div class="bg-surface-bright p-6 rounded-lg border border-outline-variant/20 soft-shadow flex flex-col hover:border-primary/40 transition-all group">
<div class="aspect-video rounded mb-4 overflow-hidden flex items-center justify-center relative">
<img src="/assets/button_debounce_demo.svg" alt="Button Debounce Demo" class="object-contain w-full h-full" />
</div>
...
<div class="bg-surface-bright p-6 rounded-lg border border-outline-variant/20 soft-shadow flex flex-col hover:border-primary/40 transition-all group">
<div class="aspect-video rounded mb-4 overflow-hidden flex items-center justify-center relative">
<img src="/assets/pwm_led_brightness.svg" alt="PWM LED Brightness" class="object-contain w-full h-full" />
</div>
